...
const UserManagement = () => {
    ...
    if (loading) {
        return (
            <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50/30 to-purple-50/30 dark:from-black dark:via-gray-900/50 dark:to-black relative overflow-hidden">
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50/30 to-purple-50/30 dark:from-gray-900/50 dark:via-gray-800/30 dark:to-gray-900/50 relative overflow-hidden">
            ...
            <div className="relative z-10 p-8">
                ...
                <div className="mb-12">
                    <div className="mb-8 flex justify-between items-center">
                        <div className="flex gap-4">
                            <button
                                onClick={handleBack}
                                className="flex items-center gap-2 px-6 py-3 bg-white dark:bg-gray-900 hover:bg-gray-50 dark:hover:bg-gray-800 rounded-xl transition-all duration-200 shadow-lg border border-gray-200 dark:border-gray-700 hover:shadow-xl text-gray-700 dark:text-gray-100"
                            >
                                <FaArrowLeft />
                                Back to Admin
                            </button>
                ...
                {/* Search and Filter */}
                <div className="mb-6 p-6 rounded-lg shadow-lg bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full pl-10 pr-4 py-2 rounded-lg border focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-800 border-gray-300 dark:border-gray-600 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400"
                            />
                        </div>
                        {/* Role Filter */}
                        <div className="relative">
