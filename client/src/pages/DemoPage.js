        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-xl font-bold text-slate-800 dark:text-slate-200">VizGraph Demo</h1>
            </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            ...
            <button
              ...
              className="group flex items-center gap-2 px-8 py-4 border-2 border-gray-300 dark:border-gray-600 text-slate-700 dark:text-slate-300 hover:border-blue-500 dark:hover:border-blue-400 rounded-xl font-semibold text-lg transition-all duration-300 hover:bg-blue-50 dark:hover:bg-gray-800"
            >
        ...
        <div className="text-center mt-12">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-6 py-3 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 text-slate-800 dark:text-slate-200 rounded-xl font-medium transition-all duration-300 hover:scale-105"
          >
            <FiDownload />
