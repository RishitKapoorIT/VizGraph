...
const FileCard = ({ file, onDelete }) => (
  <div className="group relative bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg hover:shadow-xl border border-gray-200 dark:border-gray-700 hover:border-blue-400 dark:hover:border-blue-500 transition-all duration-300">
    ...
    <div className="grid grid-cols-2 gap-3">
      <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-3">
        <div className="flex items-center gap-2 mb-1">
          <FiDatabase className="text-gray-600 dark:text-gray-400" size={12} />
          <span className="text-xs font-medium text-gray-600 dark:text-gray-400">Data Points</span>
        </div>
      ...
      <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-3">
        <div className="flex items-center gap-2 mb-1">
          <FiCalendar className="text-gray-600 dark:text-gray-400" size={12} />
          <span className="text-xs font-medium text-gray-600 dark:text-gray-400">Uploaded</span>
        </div>
...
const AnalysisCard = ({ analysis, onDelete }) => (
  <div className="group relative bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg hover:shadow-xl border border-gray-200 dark:border-gray-700 hover:border-purple-400 dark:hover:border-purple-500 transition-all duration-300">
    <div className="flex items-start justify-between mb-4">
      <div className="flex items-center gap-3">
    ...
    <div className="grid grid-cols-2 gap-3 mb-3">
      <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-3">
        <div className="flex items-center gap-2 mb-1">
          <FiPieChart className="text-gray-600 dark:text-gray-400" size={12} />
          <span className="text-xs font-medium text-gray-600 dark:text-gray-400">Chart Type</span>
        </div>
...
const StatsCard = ({ title, value, icon: Icon, color, subtitle }) => (
  <div className={`group relative bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg hover:shadow-xl border border-${color}-200 dark:border-${color}-800/50 hover:border-${color}-400 dark:hover:border-${color}-500 transition-all duration-300 overflow-hidden`}>
      ...
      <div className="relative z-10 p-8 text-gray-900 dark:text-white">
        ...
        <div className="mb-12">
          ...
          <div className="text-center">
            <h1 className="text-5xl font-bold bg-gradient-to-r from-gray-900 via-purple-600 to-purple-800 dark:from-white dark:via-purple-200 dark:to-purple-400 bg-clip-text text-transparent mb-4">
              Data Management
            </h1>
        ...
        {isLoading && (
          <div className="flex flex-col items-center justify-center py-16">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-lg">Loading data management information...</p>
          </div>
        )}
        ...
        {!isLoading && !error && (
          <>
            ...
            {activeTab === 'overview' && (
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-all duration-300">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <p className="text-gray-600 dark:text-gray-400 text-sm font-medium">Total Files</p>
                        <p className="text-2xl font-bold text-gray-900 dark:text-white">{files.length || 0}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-all duration-300">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-2xl font-bold text-gray-900 dark:text-white">{analyses.length || 0}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-all duration-300">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <p className="text-gray-600 dark:text-gray-400 text-sm font-medium">This Week</p>
                        <p className="text-2xl font-bold text-gray-900 dark:text-white">{files.filter(f => {
                  ...
                  <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-all duration-300">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-2xl font-bold text-gray-900 dark:text-white">{new Set(files.map(f => f.user?.email).filter(Boolean)).size || 0}</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  {/* Data Usage Summary */}
                  <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-800 rounded-2xl p-6 border border-blue-200 dark:border-gray-700">
                    ...
                    <div className="space-y-4">
                      <div className="flex justify-between items-center">
                        <span className="text-gray-600 dark:text-gray-400">CSV Files Uploaded</span>
                        <span className="font-semibold text-gray-900 dark:text-white">{files.length || 0}</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-gray-600 dark:text-gray-400">Charts Generated</span>
                        <span className="font-semibold text-gray-900 dark:text-white">{analyses.length || 0}</span>
                      </div>
                      <div className="flex justify-between items-center">
                      ...
                      <div className="flex justify-between items-center">
                        <span className="text-gray-600 dark:text-gray-400">Avg. Files per User</span>
                        <span className="font-semibold text-gray-900 dark:text-white">
                  ...
                  {/* Activity Timeline */}
                  <div className="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-gray-800 dark:to-gray-800 rounded-2xl p-6 border border-purple-200 dark:border-gray-700">
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
                    ...
                    <div className="space-y-4">
                      <div>
                        <div className="flex justify-between items-center mb-2">
                          <span className="text-gray-600 dark:text-gray-400 text-sm">Files This Week</span>
                      ...
                      <div>
                        <div className="flex justify-between items-center mb-2">
                          <span className="text-gray-600 dark:text-gray-400 text-sm">Charts This Week</span>
                          <span className="text-sm font-medium text-gray-900 dark:text-white">
                            {analyses.filter(a => {
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Quick Data Management Actions</h3>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    >
                      ...
                      <div className="text-left">
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400">View and delete uploaded files</p>
                      </div>
                    </button>
                    ...
                    >
                      <FiBarChart className="text-purple-600 dark:text-purple-400" size={20} />
                      <div className="text-left">
                        <p className="font-medium text-gray-900 dark:text-white">Manage Analyses</p>
                        <p className="text-sm text-gray-600 dark:text-gray-400">View and delete chart analyses</p>
                      </div>
                    </button>
                    ...
                    >
                      ...
                      <div className="text-left">
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400">Update all statistics</p>
                      </div>
                    </button>
                  </div>
                </div>
              ...
              <div className="space-y-8">
                ...
                {dashboardStats.chartTypeStats && dashboardStats.chartTypeStats.length > 0 && (
                  <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
                    <h3 className="text-xl font-semibold mb-4 text-gray-900 dark:text-white">Chart Type Distribution</h3>
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                      {dashboardStats.chartTypeStats.map((stat, index) => (
                        <div key={stat._id} className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4 text-center">
                          <p className="text-2xl font-bold text-purple-600 dark:text-purple-400">{stat.count}</p>
                          <p className="text-sm font-medium text-gray-700 dark:text-gray-300 capitalize">{stat._id}</p>
                        </div>
                      ))}
                    </div>
                  </div>
                ...
                {dashboardStats.topUsers && dashboardStats.topUsers.length > 0 && (
                  <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
                    <h3 className="text-xl font-semibold mb-4 text-gray-900 dark:text-white">Most Active Users</h3>
            ...
            {activeTab === 'files' && (
              <div>
                <div className="flex items-center justify-between mb-6">
                  ...
                  <span className="text-gray-600 dark:text-gray-400 text-sm">{files.length} files</span>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {files.length > 0 ? (
                    ...
                    <div className="col-span-full text-center py-16">
                      ...
                      <h3 className="text-xl font-semibold text-gray-500 mb-2">No files found</h3>
                      <p className="text-gray-400">No files have been uploaded to the platform yet</p>
                    </div>
                  )}
                </div>
              </div>
            ...
            {activeTab === 'analyses' && (
              <div>
                <div className="flex items-center justify-between mb-6">
                  <h2 className="text-2xl font-semibold text-gray-900 dark:text-white">Analysis Management</h2>
                  <span className="text-gray-600 dark:text-gray-400 text-sm">{analyses.length} analyses</span>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {analyses.length > 0 ? (
                    ...
                    <div className="col-span-full text-center py-16">
                      <div className="w-24 h-24 bg-gray-200 dark:bg-gray-700 rounded-full flex items-center justify-center mx-auto mb-6">
                        <FiBarChart className="text-gray-500" size={32} />
                      </div>
                      <h3 className="text-xl font-semibold text-gray-500 mb-2">No analyses found</h3>
                      <p className="text-gray-400">No analyses have been created on the platform yet</p>
                    </div>
                  )}
                </div>
              </div>
